...
const styles = {
  container: { height:'100dvh', display:'flex', flexDirection:'column', justifyContent:'center', gap:'1.5rem', padding:'calc(2rem + env(safe-area-inset-top)) 2rem calc(2rem + env(safe-area-inset-bottom))', background:'#141414', position:'relative', animation:'fadeIn 0.4s ease forwards', boxSizing:'border-box', overflowY:'auto' },
